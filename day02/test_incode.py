...
def test_example1():
    ...
    int_code.run()
    assert int_code.dump() == "2,0,0,0,99"


def test_example2():
    """Example 2: 2,3,0,3,99 becomes 2,3,0,6,99 (3 * 2 = 6)
    """
    assert IntCode("2,3,0,3,99").run().dump() == "2,3,0,6,99"


def test_example3():
    """Example 3: 2,4,4,5,99,0 becomes 2,4,4,5,99,9801 (99 * 99 = 9801)
    """
    assert IntCode("2,4,4,5,99,0").run().dump() == "2,4,4,5,99,9801"


def test_example4():
    """Example 4: 1,1,1,4,99,5,6,0,99 becomes 30,1,1,4,2,5,6,0,99
    """
    assert IntCode("1,1,1,4,99,5,6,0,99").run().dump() == "30,1,1,4,2,5,6,0,99"
